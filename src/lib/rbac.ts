...
export const ROLE_ACTIONS: Record<Role, Action[]> = {
  ...
  hr_partner: ["view_all_workforce", "explore_skill_graph", "approve_recommendations", "view_onboarding", "use_policy_studio", "review_staffing_proposals"],
