...
export const TWINS: TwinSeed[] = [
  {
    ...
    verified_skills: [
      ...
      { name: "Data Visualization", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "Stakeholder Communication", proficiency: 4, evidence_source: "performance_review", verification_rigor: "high" },
      { name: "Change Management", proficiency: 3, evidence_source: "certification", verification_rigor: "medium" },
      { name: "Statistics", proficiency: 3, evidence_source: "certification", verification_rigor: "medium" },
    ],
    interview_rubrics: [],
    performance_history: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "REST APIs", proficiency: 4, evidence_source: "project", verification_rigor: "medium" },
      { name: "Distributed Systems", proficiency: 4, evidence_source: "project", verification_rigor: "medium" },
      { name: "Coaching", proficiency: 3, evidence_source: "peer_feedback", verification_rigor: "medium" },
      { name: "Succession Planning", proficiency: 3, evidence_source: "certification", verification_rigor: "medium" },
    ],
    interview_rubrics: [],
    performance_history: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "Docker", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "SQL", proficiency: 2, evidence_source: "project", verification_rigor: "medium" },
      { name: "REST APIs", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "PostgreSQL", proficiency: 4, evidence_source: "project", verification_rigor: "medium" },
      { name: "Kubernetes", proficiency: 2, evidence_source: "certification", verification_rigor: "medium" },
      { name: "CI/CD", proficiency: 2, evidence_source: "project", verification_rigor: "medium" },
      { name: "Event-driven architecture", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
    ],
    interview_rubrics: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "Data Modeling", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "Statistics", proficiency: 4, evidence_source: "certification", verification_rigor: "high" },
      { name: "Data Visualization", proficiency: 4, evidence_source: "project", verification_rigor: "medium" },
      { name: "dbt", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "ETL", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "Machine Learning fundamentals", proficiency: 2, evidence_source: "certification", verification_rigor: "medium" },
    ],
    interview_rubrics: [],
    performance_history: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "Coaching", proficiency: 4, evidence_source: "performance_review", verification_rigor: "high" },
      { name: "Employee Relations", proficiency: 3, evidence_source: "project", verification_rigor: "medium" },
      { name: "Onboarding Design", proficiency: 3, evidence_source: "certification", verification_rigor: "medium" },
      { name: "Compensation Design", proficiency: 2, evidence_source: "certification", verification_rigor: "medium" },
    ],
    interview_rubrics: [],
    performance_history: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "Data Visualization", proficiency: 2, evidence_source: "certification", verification_rigor: "medium" },
      { name: "People Analytics", proficiency: 2, evidence_source: "certification", verification_rigor: "medium" },
      { name: "Product Strategy", proficiency: 2, evidence_source: "certification", verification_rigor: "medium" },
    ],
    interview_rubrics: [],
    performance_history: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "Kubernetes", proficiency: 3, evidence_source: "work_sample", verification_rigor: "high" },
      { name: "REST APIs", proficiency: 4, evidence_source: "interview_rubric", verification_rigor: "high" },
      { name: "Event-driven architecture", proficiency: 3, evidence_source: "technical_assessment", verification_rigor: "medium" },
    ],
    interview_rubrics: [
  ...
  },
  {
    ...
    verified_skills: [
      ...
      { name: "Tableau", proficiency: 3, evidence_source: "work_sample", verification_rigor: "high" },
      { name: "dbt", proficiency: 2, evidence_source: "technical_assessment", verification_rigor: "medium" },
      { name: "Machine Learning fundamentals", proficiency: 2, evidence_source: "technical_assessment", verification_rigor: "medium" },
    ],
    interview_rubrics: [
